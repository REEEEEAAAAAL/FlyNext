		...
		return NextResponse.json({
			bookings: bookings.map((b) => ({
				...
				departure: {
					...
					returnDate: b.departure.returnDate? b.departure.returnDate : " ",
					goAirport: b.departure.goAirport? b.departure.goAirport : " ",
					returnAirport: b.departure.returnAirport? b.departure.returnAirport : " ",
				},
				arrival: {
					goDate: b.arrival.goDate? b.arrival.goDate : " ",
					returnDate: b.arrival.returnDate ? b.arrival.returnDate : " ",
					goAirport: b.arrival.goAirport? b.arrival.goAirport : " ",
					returnAirport: b.arrival.returnAirport ? b.arrival.returnAirport : " ",
				},
